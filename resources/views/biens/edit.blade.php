...
@section('title', 'Modifier l offre d un bien')
...
@section('content')
     ...
     <div class="row justify-content-center">
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">Modification d&lsquo;une offre de bien</div>
                    
                    <form method="post" class="form" class="table" action="{{ route('biens.update', $bien->id) }}">
                         @method('PATCH')
                         @csrf
                         <div class="container">
